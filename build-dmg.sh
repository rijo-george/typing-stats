...
svg = f'''<svg xmlns="http://www.w3.org/2000/svg" width="{width}" height="{height}">
  ...
  <text x="300" y="60" text-anchor="middle" font-family="Helvetica Neue" font-size="16" font-weight="bold" fill="#c4581a">Typing Stats</text>
  <text x="300" y="260" text-anchor="middle" font-family="Helvetica Neue" font-size="13" fill="#7a746a">Drag the app to Applications</text>
</svg>'''
